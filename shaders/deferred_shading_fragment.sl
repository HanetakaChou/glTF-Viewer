...
brx_pixel_shader_parameter_end(main)
{
	...
	const brx_float3 incident_illuminances[2] = brx_array_constructor_begin(brx_float3, 2) 
		brx_float3(1.0, 1.0, 1.0) brx_array_constructor_split
		brx_float3(1.0, 1.0, 1.0)
        brx_array_constructor_end;

	const brx_float3 Ls[2] = brx_array_constructor_begin(brx_float3, 2) 
		brx_float3(0.73994, 0.64279, 0.19827) brx_array_constructor_split
		brx_float3(-0.73994, 0.64279, 0.19827)
        brx_array_constructor_end;

	brx_unroll
	for(brx_int incident_light_index = 0; incident_light_index < 2; ++incident_light_index)
	{
