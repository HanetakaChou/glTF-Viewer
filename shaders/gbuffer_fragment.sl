...
brx_pixel_shader_parameter_end(main)
{
    ...
    brx_branch
    if(0u != (geometry_material_flags & Material_Texture_Enable_Normal))
    {
    ...
    brx_branch
    if(0u != (geometry_material_flags & Material_Texture_Enable_Emissive))
    {
    ...
    brx_branch
    if(0u != (geometry_material_flags & Material_Texture_Enable_Base_Color))
    {
    ...
    brx_branch
    if(0u != (geometry_material_flags & Material_Texture_Enable_Metallic_Roughness))
    {
