...
{
    brx_uint geometry_material_flags = brx_byte_address_buffer_load(g_asset_buffers[3], 0);
    ...
    if(0u != (geometry_material_flags & Geometry_Flag_Index_Type_UInt16))
    {
        ...
        brx_uint packed_vector_index_buffer = brx_byte_address_buffer_load(g_asset_buffers[2], index_buffer_offset);
    ...
    else
    {
        ...
        vertex_index = brx_byte_address_buffer_load(g_asset_buffers[2], index_buffer_offset);
    }
