...
class renderer
{
	...
	std::vector<brx_frame_buffer *> m_swap_chain_frame_buffers;
...
public:
	...
	void init(void *wsi_connection, std::vector<std::string> const &file_names);
...
extern renderer *renderer_init(void *wsi_connection, std::vector<std::string> const &file_names)
{
...
void renderer::init(void *wsi_connection, std::vector<std::string> const &file_names)
{
