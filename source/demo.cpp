                        ...
                        for (size_t mesh_index = 0U; mesh_index < total_mesh_data.size(); ++mesh_index)
                        {
                            ...
                            for (size_t subset_index = 0U; subset_index < in_mesh_data.m_subsets.size(); ++subset_index)
                            {
...

                                {
                                    ...
                                    {
                                        mcrt_vector<uint16_t> converted_indices(static_cast<size_t>(out_subset.m_index_count));
...

                                {
                                    ...
                                    mcrt_string const *const meterial_texture_image_uris[] = {
                                    ...
                                    {
                                        mcrt_string const &meterial_texture_image_uri = (*meterial_texture_image_uris[mesh_subset_meterial_texture_index]);
