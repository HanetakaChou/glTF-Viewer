...
$(OBJ_DIR)/libImportAsset.a: $(THIRD_PARTY_DIR)/ImportAsset/build-linux/bin/$(CONFIG_NAME)/libImportAsset.a
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) cp -f $(THIRD_PARTY_DIR)/ImportAsset/build-linux/bin/$(CONFIG_NAME)/libImportAsset.a $(OBJ_DIR)/libImportAsset.a
