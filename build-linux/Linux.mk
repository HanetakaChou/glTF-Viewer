...
ifeq (true, $(APP_DEBUG))
$(BIN_DIR)/Demo-Linux: \
	$(OBJ_DIR)/Demo-assets-house.o \
	$(OBJ_DIR)/Demo-assets-plane.o \
...
$(BIN_DIR)/Demo-Linux: \
	...
	$(HIDE) $(CC) -pie $(LD_FLAGS) \
		...
		-L$(BIN_DIR) -lBRX \
		-lxcb \
		-o $(BIN_DIR)/Demo-Linux

# Compile
$(OBJ_DIR)/Demo-assets-house.o: $(SOURCE_DIR)/../assets/house.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) $(CC) -c $(C_FLAGS) $(SOURCE_DIR)/../assets/house.cpp -MD -MF $(OBJ_DIR)/Demo-assets-house.d -o $(OBJ_DIR)/Demo-assets-house.o

$(OBJ_DIR)/Demo-assets-plane.o: $(SOURCE_DIR)/../assets/plane.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) $(CC) -c $(C_FLAGS) $(SOURCE_DIR)/../assets/plane.cpp -MD -MF $(OBJ_DIR)/Demo-assets-plane.d -o $(OBJ_DIR)/Demo-assets-plane.o
...
-include \
	$(OBJ_DIR)/Demo-assets-house.d \
	$(OBJ_DIR)/Demo-assets-plane.d \
...
clean:
	$(HIDE) rm -f $(BIN_DIR)/Demo-Linux
	$(HIDE) rm -f $(OBJ_DIR)/Demo-assets-house.o
	$(HIDE) rm -f $(OBJ_DIR)/Demo-assets-plane.o
	...
	$(HIDE) rm -f $(OBJ_DIR)/Demo-assets-house.d
	$(HIDE) rm -f $(OBJ_DIR)/Demo-assets-plane.d
