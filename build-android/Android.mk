...
LOCAL_SRC_FILES := \
	...
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_asset_input_stream_file.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_asset_input_stream_memory.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_image_asset_dds.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_image_asset_pvr.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_scene_asset_gltf_cgltf.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_scene_asset_gltf.cpp \
	$(LOCAL_PATH)/../thirdparty/ImportAsset/source/import_scene_asset.cpp
...
ifeq (true, $(APP_DEBUG))
	LOCAL_C_INCLUDES += $(LOCAL_PATH)/../spirv/debug
else
	LOCAL_C_INCLUDES +=$(LOCAL_PATH)/../spirv/release
endif
