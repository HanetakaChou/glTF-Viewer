...
graph TD
    ...
    Mesh_Subset_Asset_Geometry_Metrial_Buffer_Texture["Mesh Subset Asset Geometry Material Buffer <br> <hr> <br> Mesh Subset Asset Material Textures"]
